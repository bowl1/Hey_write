...
Template mode uses vector similarity distance for match gating (`similarity_search_with_score`), with default threshold `SIMILARITY_THRESHOLD = 0.38` in `chatbox-backend/langchain_runner/rag_chain.py`.
